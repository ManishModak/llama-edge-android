...
object BenchmarkResultJson {
    fun encode(result: BenchmarkResult): String = buildString {
        ...
        append("\"executionBackend\":\"")
            .append(result.traceability.executionBackend.name).append("\",")
        append("\"gpuLayers\":").append(result.traceability.gpuLayers).append(',')
        append("\"backendPolicyIdentitySha256\":")
        appendNullableString(result.traceability.backendPolicyIdentitySha256)
        append(',')
        append("\"vulkanDeviceIdentitySha256\":")
        appendNullableString(result.traceability.vulkanDeviceIdentitySha256)
        append("},\n")
        append("  \"config\": {")
